...
// Разумеется можно было всё cделать через обычные функции и сортировку контейнера
// vector<vector<string>>. Можно было и с использованием ranges 20-го стандарта,
// но надо ли?
